# Modelos Django mejorados para Sistema CRM Universitario
# Generados con inspectdb y mejorados manualmente
...
class Usuario(models.Model):
    ...
    rol = models.CharField(max_length=20, choices=ROLES_CHOICES, verbose_name="Rol del usuario")
...
class Administrador(models.Model):
    ...
    """
    id_admin = models.AutoField(primary_key=True)  # Corregido el typo 'id_adimin'
...
class MateriaClase(models.Model):
    ...
    """
    id_materia = models.AutoField(primary_key=True)  # Renombrado para claridad
    nombre_materia = models.CharField(max_length=100, verbose_name="Nombre de la materia")
    codigo_materia = models.CharField(max_length=100, unique=True, verbose_name="Código de materia")
    creditos = models.IntegerField(default=3, verbose_name="Créditos")
...
class Clase(models.Model):
    ...
    def estudiantes_inscritos(self):
        ...
        return self.estudiantes_inscritos.count()
